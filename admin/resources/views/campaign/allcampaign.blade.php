...
@section('content')
        ...
        <div class="bg-body-light">
            <div class="content content-full">
                <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                    <h1 class="flex-sm-fill font-size-h2 font-w400 mt-2 mb-0 mb-sm-2">Bütün Kampaniyalar</h1>
                    <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item">Ana səhifə</li>
                            <li class="breadcrumb-item active" aria-current="page">Bütün Kampaniyalar</li>
                        </ol>
                    </nav>
                </div>
            </div>
                    ...
                    <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                        ...
                        @foreach($datas as $key=>$data)
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-outline-info" onclick="viewcamp({{$data->id}})">Bax</button>
                                    <button class="btn btn-outline-primary" onclick="editcamp({{$data->id}})">Redaktə et</button>
                                    <button class="btn btn-outline-danger" onclick="deletecamp({{$data->id}})">Sil</button>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
    ...
    <div class="modal fade" id="viewcamp" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
         aria-hidden="true">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div >
                                <img style="width: 100% !important; height: 200px;" id="image" src="">
                            </div>
                        </div>
                        <div class="form-group">
    ...
    <div class="modal fade" id="editcamp" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
         aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <form action="{{route('updatecampaign')}}" enctype="multipart/form-data" method="POST">
                        @csrf
                    ...
                    <div class="form-group">
                        <label for="title" class="col-form-label">Haqqında:</label>
                        <textarea type="text" class="form-control" id="edit_content" name="edit_content"></textarea>
                    </div>
                    <div class="form-group">
                        <label for="image" class="col-form-label">Cari şəkil:</label>
                        <div >
                            <img style="width: 100% !important; height: 200px;" id="edit_image" src="">
                            <label for="edit_image" class="col-form-label">Sekil:</label>
                            <div class="custom-file">
                                <!-- Populating custom file input label with the selected filename (data-toggle="custom-file-input" is initialized in Helpers.coreBootstrapCustomFileInput()) -->
                                <input type="file" class="custom-file-input" data-toggle="custom-file-input" id="example-file-input-custom" name="edit_image">
...
@section('js')
    ...
    <script>
       ...
       const deletecamp = (id) => {
           ...
           swal({
               title: "Əminsiz?",
               text: "Silinən kampaniya ilə bağlı bütün məlumatlar silinəcək!",
               icon: "warning",
