        ...
        <div class="bg-body-light">
            <div class="content content-full">
                <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                    <h1 class="flex-sm-fill font-size-h2 font-w400 mt-2 mb-0 mb-sm-2">Blog Redaktə et</h1>
        ...
        <div class="content content-full content-boxed">
            <div class="block block-rounded">
                <div class="block-content">
                    <form action="{{route('updateBlog')}}" method="POST" id="form-add" enctype="multipart/form-data">
                    @csrf
                    @include('layouts.error_messages')
                    <!-- User Profile -->
                        <h2 class="content-heading pt-0">
                            <i class="fas fa-pencil-alt text-muted mr-1"></i>Blog Redaktə et
                        </h2>
                        ...
                        <div class="row push">
                            <div style="margin: auto" class="col-lg-10 col-xl-10">
                                ...
                                <div class="form-group">
                                    ...
                                    <img src="{{asset($blog->image)}}" style="margin-bottom: 20px" />
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" data-toggle="custom-file-input" id="example-file-input-custom" name="image">
                                        <label class="custom-file-label" for="example-file-input-custom">Yeni şəkil seçin</label>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="name">Yazı: </label>
                                    <textarea class="form-control" id="open-source-plugins" name="blog_content">{{$blog->content}}</textarea>
                                </div>
                                <div class="form-group">
                                    <label for="name">Açar sözlər: </label>
                                    <input type="text" required="required" name="tags" value="{{$blog->tags}}" data-role="tagsinput"/>
                                </div>
                            </div>
                        </div>
                        <!-- END User Profile -->
