...
@section('content')
        ...
        <div class="bg-body-light">
            <div class="content content-full">
                <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                    <h1 class="flex-sm-fill font-size-h2 font-w400 mt-2 mb-0 mb-sm-2">Xidmətlər</h1>
                ...
                <div class="block-content block-content-full">
                    ...
                    @foreach($datas as $key=>$data)
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-outline-info" onclick="viewService({{$data->id}})">Bax</button>
                                    <button class="btn btn-outline-primary" onclick="editService({{$data->id}})">Redaktə et</button>
                                    <button class="btn btn-outline-danger" onclick="deleteService({{$data->id}})">Sil</button>
                                </td>
                            </tr>
                    @endforeach
                        </tbody>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{route('addService')}}" enctype="multipart/form-data" method="POST">
                        @csrf
    ...
    <div class="modal fade" id="viewService" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
         aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <div class="modal fade" id="editService" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                <form action="{{route('updateService')}}" enctype="multipart/form-data" method="POST">
                    @csrf
...
@section('js')
    ...
    <script>
        ...
        const changeStatus = (id,status) => {
            ...
            $.ajax({
                type: "POST",
                url: "/services/service/change/status",
                data: {
        ...
        const deleteService = (id) => {
            swal({
                title: "Əminsiniz?",
                text: "Silinən xidmət geri qayıtmayacaq!",
                icon: "warning",
